...
import { Download, FolderOpen, MapPin, Linkedin, Instagram, Github } from "lucide-react";
...
document.getElementById("projects")?.scrollIntoView({ behavior: "smooth" });
  ...
  return (
    ...
    >
      ...
      {/* Left Content */}
      <div className="space-y-6 self-center pb-16">
        ...
        >
          A passionate coder and competitive thinker from PSG CAS, dedicated 
          to turning creative ideas into impactful solutions. With 15+ competition 
          wins and a love for hackathons, I thrive where innovation meets execution.
        </motion.p>
        ...
        >
          <motion.a
            ...
            whileTap={{ scale: 0.95 }}
            className="flex items-center gap-2 px-6 py-3 bg-blue-600 hover:bg-blue-500 rounded-xl font-semibold text-white transition-all duration-200"
          >
            <Download size={18} />
            Download Resume
          </motion.a>
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="flex items-center gap-2 px-6 py-3 border border-blue-500/50 rounded-xl font-semibold text-gray-300 hover:text-white hover:border-blue-400 hover:bg-blue-900/20 transition-all duration-200"
          >
            <FolderOpen size={18} />
            View Projects
          </motion.button>
